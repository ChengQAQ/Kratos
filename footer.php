						...
						<div class="container">
							<div class="row">
								<div class="col-md-6 col-md-offset-3 footer-list text-center">
									...
									<?php echo (!kratos_option('social_telegram')) ? '' : '<a target="_blank" rel="nofollow" href="' . kratos_option('social_telegram') . '"><i class="fa fa-telegram-plane"></i></a>'; ?>
									</p>
									<p>Copyright <?php echo date('Y'); ?> <a href="<?php echo get_option('home'); ?>"><?php bloginfo('name'); ?></a>. All Rights Reserved.<br>Theme <a href="https://github.com/vtrois/kratos" target="_blank" rel="nofollow">Kratos</a> made by <a href="https://www.vtrois.com/" target="_blank" rel="nofollow">Vtrois</a><br><?php if(kratos_option('custom_footer')){ echo kratos_option('custom_footer');} ?>
